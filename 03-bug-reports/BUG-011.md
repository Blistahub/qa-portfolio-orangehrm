...
| --- | --- |
| `BUG-011-01-sugerencia.png` | El desplegable ofreciendo al propio empleado como supervisor |
| `BUG-011-02-guardado.png` | *Assigned Supervisors* con el propio empleado tras guardar |
| `BUG-011-03-ciclo.png` | El mismo empleado presente también en *Assigned Subordinates* |
